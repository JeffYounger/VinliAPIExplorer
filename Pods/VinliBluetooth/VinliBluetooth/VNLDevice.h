...
@property (readonly, nonatomic) NSString* cellularSignalType;
@property (readonly, nonatomic) NSNumber* cellularSignalStrength;
@property (readonly, nonatomic) BOOL hasGPSConnection;
@property (readonly, nonatomic) BOOL hasCellularConnection;
@property (readonly, nonatomic) BOOL hasWifiConnection;
