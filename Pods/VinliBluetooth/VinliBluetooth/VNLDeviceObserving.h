 ...
 */
- (void)device:(VNLDevice *)device didUpdateBatterVoltage:(NSNumber *)voltage;

- (void)device:(VNLDevice *)device didUpdateGPSState:(BOOL)on;
- (void)device:(VNLDevice *)device didUpdateCellularConnectionState:(BOOL)on;
- (void)device:(VNLDevice *)device didUpdateCellularSignalType:(NSString *)type decibals:(NSNumber *)decibals;
...
- (void)deviceManager:(VNLDeviceManager *)deviceManager deviceDidEnterRegion:(VNLDevice *)device;
- (void)deviceManager:(VNLDeviceManager *)deviceManager deviceDidExitRegion:(VNLDevice *)device;
- (void)deviceManager:(VNLDeviceManager *)deviceManager didDiscoverVinliBeaconWithIdentifier:(NSString *)identifier;
